...
start cmd /k "title FastAPI Backend && call venv\Scripts\activate.bat && cd backend && python -m uvicorn main:app --reload --port 8000"
...
start cmd /k "title Streamlit Frontend && call venv\Scripts\activate.bat && cd frontend && python -m streamlit run app.py"
